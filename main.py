...
class User(UserMixin, db.Model):
    ...
    # first argument of relationship() is to the class name of the child/parent
...
class BlogPost(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    # ForeignKey() references the tablename, not class!
...
# todo 4. Establish a One to Many relationship between each BlogPost object (Parent) and Comment object (Child).
